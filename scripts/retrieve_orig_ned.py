...
download_dir = os.path.join(cur_dir, '..', 'data', 'orig_ned')

# Output dir for final NED tiles
out_dir =  os.path.join(cur_dir, '..', 'data', 'ned_out')


print('Retrieving USGS 1-arc-second tiles to dir=%s' % download_dir)
...
# reference directory
RetrieveElevationTilesAndProcess(out_dir)
