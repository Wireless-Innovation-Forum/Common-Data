...
data_dir = os.path.join(root_dir, 'data', 'zones')

    
doc = ReadKML(os.path.join(data_dir, 'parts', 'uscabdry.kmz'))
...
with open(os.path.join(data_dir, 'uscabdry_tmp.kml'), 'w+') as outputFile:
