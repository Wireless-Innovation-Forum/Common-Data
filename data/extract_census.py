...
"""Extract USGS Census Tract data.

The zipped tiles are stored in Git LFS under census/ folders.
"""
...
census_dir = os.path.join(geo_dir, 'census')
print 'Extracting Census Tract data files from zip files in dir=%s' % census_dir
ExtractData(census_dir)
